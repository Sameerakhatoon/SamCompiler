...
// ch255: error formatter for the validator. Same shape as
// compiler_error, but anchored at a parse-tree node's position so
// validation diagnostics point at the offending source line.
