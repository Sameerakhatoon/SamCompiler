...
// ch238: va_start(list, final_argument_in_function). Emits the asm
// that loads the address-of `final_argument_in_function` (which sits
// at the top of the varargs region of the stack) into `list`.
