...
// ch236: register a C-implemented native function as a symbol so the
// resolver / codegen can dispatch through the v-table.
...
// ch237: look up a previously-registered native function by name.
